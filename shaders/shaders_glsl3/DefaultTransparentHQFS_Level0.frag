...
void main()
{
    ...
    vec3 f26 = -CB0[16].xyz;
    float f27 = (dot(f4, f26) * CB0[14].w) * ((1.0 - ((step(f19.x, f20) * clamp(CB0[29].z + (CB0[29].w * abs(f20 - 0.5)), 0.0, 1.0)) * f19.y)) * f17.y);
    ...
    float f58 = f52.y;
    float f59 = f52.z;
    vec3 f60 = ((((((((f41 - (f36 * f40)) * CB0[15].xyz) * f29) + (CB0[17].xyz * (f39 * clamp(-f27, 0.0, 1.0)))) + ((f16.xyz * (f16.w * 120.0)) * 1.0)) + ((f41 - (f49 * f40)) * (((((((CB0[40].xyz * f54) + (CB0[42].xyz * f55)) + (CB0[44].xyz * f56)) + (CB0[41].xyz * f57)) + (CB0[43].xyz * f58)) + (CB0[45].xyz * f59)) + (((((((CB0[34].xyz * f54) + (CB0[36].xyz * f55)) + (CB0[38].xyz * f56)) + (CB0[35].xyz * f57)) + (CB0[37].xyz * f58)) + (CB0[39].xyz * f59)) * f18)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f18))) * f9.xyz) + ((((f36 * (((f37 + (f37 * f37)) / (((f38 * f38) * ((f32 * 3.0) + 0.5)) * ((f31 * 0.75) + 0.25))) * f29)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f45, textureLod(PrefilteredEnvTexture, f43, f42).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f23.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f18)) * f49) * f21));
    vec4 f61 = vec4(0.0);
    f61.x = f60.x;
    vec4 f62 = f61;
    f62.y = f60.y;
