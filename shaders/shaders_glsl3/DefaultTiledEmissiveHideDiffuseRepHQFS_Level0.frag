...
void main()
{
    ...
    vec3 f42 = -CB0[16].xyz;
    float f43 = (dot(f20, f42) * CB0[14].w) * ((1.0 - ((step(f35.x, f36) * clamp(CB0[29].z + (CB0[29].w * abs(f36 - 0.5)), 0.0, 1.0)) * f35.y)) * f33.y);
    ...
    float f74 = f68.y;
    float f75 = f68.z;
    vec3 f76 = (((((((((f57 - (f52 * f56)) * CB0[15].xyz) * f45) + (CB0[17].xyz * (f55 * clamp(-f43, 0.0, 1.0)))) + ((f32.xyz * (f32.w * 120.0)) * 1.0)) + ((f57 - (f65 * f56)) * (((((((CB0[40].xyz * f70) + (CB0[42].xyz * f71)) + (CB0[44].xyz * f72)) + (CB0[41].xyz * f73)) + (CB0[43].xyz * f74)) + (CB0[45].xyz * f75)) + (((((((CB0[34].xyz * f70) + (CB0[36].xyz * f71)) + (CB0[38].xyz * f72)) + (CB0[35].xyz * f73)) + (CB0[37].xyz * f74)) + (CB0[39].xyz * f75)) * f34)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f34))) + vec3(((1.0 - f15.w) * 2.0) * f2)) * f25.xyz) + ((((f52 * (((f53 + (f53 * f53)) / (((f54 * f54) * ((f48 * 3.0) + 0.5)) * ((f47 * 0.75) + 0.25))) * f45)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f61, textureLod(PrefilteredEnvTexture, f59, f58).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f39.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f34)) * f65) * f37));
    vec4 f77 = vec4(0.0);
    f77.x = f76.x;
    vec4 f78 = f77;
    f78.y = f76.y;
