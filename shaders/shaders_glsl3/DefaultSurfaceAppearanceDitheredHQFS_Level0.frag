...
void main()
{
    ...
    vec3 f40 = -CB0[16].xyz;
    float f41 = (dot(f18, f40) * CB0[14].w) * ((1.0 - ((step(f33.x, f34) * clamp(CB0[29].z + (CB0[29].w * abs(f34 - 0.5)), 0.0, 1.0)) * f33.y)) * f31.y);
    ...
    float f72 = f66.y;
    float f73 = f66.z;
    vec3 f74 = ((((((((f55 - (f50 * f54)) * CB0[15].xyz) * f43) + (CB0[17].xyz * (f53 * clamp(-f41, 0.0, 1.0)))) + ((f30.xyz * (f30.w * 120.0)) * 1.0)) + ((f55 - (f63 * f54)) * (((((((CB0[40].xyz * f68) + (CB0[42].xyz * f69)) + (CB0[44].xyz * f70)) + (CB0[41].xyz * f71)) + (CB0[43].xyz * f72)) + (CB0[45].xyz * f73)) + (((((((CB0[34].xyz * f68) + (CB0[36].xyz * f69)) + (CB0[38].xyz * f70)) + (CB0[35].xyz * f71)) + (CB0[37].xyz * f72)) + (CB0[39].xyz * f73)) * f32)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f32))) * f23.xyz) + ((((f50 * (((f51 + (f51 * f51)) / (((f52 * f52) * ((f46 * 3.0) + 0.5)) * ((f45 * 0.75) + 0.25))) * f43)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f59, textureLod(PrefilteredEnvTexture, f57, f56).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f37.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f32)) * f63) * f35));
    vec4 f75 = vec4(0.0);
    f75.x = f74.x;
    vec4 f76 = f75;
    f76.y = f74.y;
