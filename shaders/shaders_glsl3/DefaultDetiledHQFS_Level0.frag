...
void main()
{
    ...
    vec3 f57 = -CB0[16].xyz;
    float f58 = (dot(f35, f57) * CB0[14].w) * ((1.0 - ((step(f50.x, f51) * clamp(CB0[29].z + (CB0[29].w * abs(f51 - 0.5)), 0.0, 1.0)) * f50.y)) * f48.y);
    ...
    float f89 = f83.y;
    float f90 = f83.z;
    vec3 f91 = ((((((((f72 - (f67 * f71)) * CB0[15].xyz) * f60) + (CB0[17].xyz * (f70 * clamp(-f58, 0.0, 1.0)))) + ((f47.xyz * (f47.w * 120.0)) * 1.0)) + ((f72 - (f80 * f71)) * (((((((CB0[40].xyz * f85) + (CB0[42].xyz * f86)) + (CB0[44].xyz * f87)) + (CB0[41].xyz * f88)) + (CB0[43].xyz * f89)) + (CB0[45].xyz * f90)) + (((((((CB0[34].xyz * f85) + (CB0[36].xyz * f86)) + (CB0[38].xyz * f87)) + (CB0[35].xyz * f88)) + (CB0[37].xyz * f89)) + (CB0[39].xyz * f90)) * f49)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f49))) * f40.xyz) + ((((f67 * (((f68 + (f68 * f68)) / (((f69 * f69) * ((f63 * 3.0) + 0.5)) * ((f62 * 0.75) + 0.25))) * f60)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f76, textureLod(PrefilteredEnvTexture, f74, f73).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f54.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f49)) * f80) * f52));
    vec4 f92 = vec4(0.0);
    f92.x = f91.x;
    vec4 f93 = f92;
    f93.y = f91.y;
