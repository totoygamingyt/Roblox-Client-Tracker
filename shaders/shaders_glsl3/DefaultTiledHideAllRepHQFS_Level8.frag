...
void main()
{
    ...
    float f65 = clamp((f25 * CB0[14].w) * (((f25 * CB0[52].x) > 0.0) ? mix(min((f49 <= f53) ? 1.0 : clamp(((f54 / (f54 + (f55 * f55))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f50 <= f56) ? 1.0 : clamp(((f57 / (f57 + (f58 * f58))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f40, clamp((length(f31 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f40), 0.0, 1.0);
    float f66 = f60 * f60;
    ...
    float f94 = f88.y;
    float f95 = f88.z;
    vec3 f96 = (((((((f77 - (f72 * f76)) * CB0[15].xyz) * f65) + ((f37.xyz * (f37.w * 120.0)) * 1.0)) + ((f77 - (f85 * f76)) * (((((((CB0[40].xyz * f90) + (CB0[42].xyz * f91)) + (CB0[44].xyz * f92)) + (CB0[41].xyz * f93)) + (CB0[43].xyz * f94)) + (CB0[45].xyz * f95)) + (((((((CB0[34].xyz * f90) + (CB0[36].xyz * f91)) + (CB0[38].xyz * f92)) + (CB0[35].xyz * f93)) + (CB0[37].xyz * f94)) + (CB0[39].xyz * f95)) * f39)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f39))) * f30.xyz) + ((((f72 * (((f73 + (f73 * f73)) / (((f74 * f74) * ((f68 * 3.0) + 0.5)) * ((f67 * 0.75) + 0.25))) * f65)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f81, textureLod(PrefilteredEnvTexture, f79, f78).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f61.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f39)) * f85) * f59));
    vec4 f97 = vec4(0.0);
    f97.x = f96.x;
    vec4 f98 = f97;
    f98.y = f96.y;
