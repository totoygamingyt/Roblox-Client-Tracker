...
void main()
{
    ...
    float f54 = CB0[31].w * f37;
    vec3 f55 = reflect(-f50, f38);
    vec3 f56 = -CB0[16].xyz;
    float f57 = (dot(f38, f56) * CB0[14].w) * ((1.0 - ((step(f48.x, f49) * clamp(CB0[29].z + (CB0[29].w * abs(f49 - 0.5)), 0.0, 1.0)) * f48.y)) * f46.y);
    vec3 f58 = normalize(f50 - CB0[16].xyz);
    ...
    float f88 = f82.y;
    float f89 = f82.z;
    vec3 f90 = (((((((((f71 - (f66 * f70)) * CB0[15].xyz) * f59) + (CB0[17].xyz * (f69 * clamp(-f57, 0.0, 1.0)))) + ((f45.xyz * (f45.w * 120.0)) * 1.0)) + ((f71 - (f79 * f70)) * (((((((CB0[40].xyz * f84) + (CB0[42].xyz * f85)) + (CB0[44].xyz * f86)) + (CB0[41].xyz * f87)) + (CB0[43].xyz * f88)) + (CB0[45].xyz * f89)) + (((((((CB0[34].xyz * f84) + (CB0[36].xyz * f85)) + (CB0[38].xyz * f86)) + (CB0[35].xyz * f87)) + (CB0[37].xyz * f88)) + (CB0[39].xyz * f89)) * f47)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f47))) + vec3((f5.z * 2.0) * f37)) * f36) + ((((((f66 * (((f67 + (f67 * f67)) / (((f68 * f68) * ((f62 * 3.0) + 0.5)) * ((f61 * 0.75) + 0.25))) * f59)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) * f37) * VARYING0.w) + ((mix(f75, textureLod(PrefilteredEnvTexture, f73, f72).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f55.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f47)) * f79) * f54));
    vec4 f91 = vec4(0.0);
    f91.x = f90.x;
    vec4 f92 = f91;
    f92.y = f90.y;
