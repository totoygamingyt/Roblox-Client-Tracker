...
void main()
{
    ...
    float f70 = clamp((f30 * CB0[14].w) * (((f30 * CB0[52].x) > 0.0) ? mix(min((f54 <= f58) ? 1.0 : clamp(((f59 / (f59 + (f60 * f60))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f55 <= f61) ? 1.0 : clamp(((f62 / (f62 + (f63 * f63))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f45, clamp((length(f36 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f45), 0.0, 1.0);
    float f71 = f65 * f65;
    ...
    float f99 = f93.y;
    float f100 = f93.z;
    vec3 f101 = (((((((f82 - (f77 * f81)) * CB0[15].xyz) * f70) + ((f42.xyz * (f42.w * 120.0)) * 1.0)) + ((f82 - (f90 * f81)) * (((((((CB0[40].xyz * f95) + (CB0[42].xyz * f96)) + (CB0[44].xyz * f97)) + (CB0[41].xyz * f98)) + (CB0[43].xyz * f99)) + (CB0[45].xyz * f100)) + (((((((CB0[34].xyz * f95) + (CB0[36].xyz * f96)) + (CB0[38].xyz * f97)) + (CB0[35].xyz * f98)) + (CB0[37].xyz * f99)) + (CB0[39].xyz * f100)) * f44)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f44))) * f35.xyz) + ((((f77 * (((f78 + (f78 * f78)) / (((f79 * f79) * ((f73 * 3.0) + 0.5)) * ((f72 * 0.75) + 0.25))) * f70)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f86, textureLod(PrefilteredEnvTexture, f84, f83).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f66.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f44)) * f90) * f64));
    vec4 f102 = vec4(0.0);
    f102.x = f101.x;
    vec4 f103 = f102;
    f103.y = f101.y;
