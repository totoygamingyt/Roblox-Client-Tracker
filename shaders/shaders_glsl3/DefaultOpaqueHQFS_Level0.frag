...
void main()
{
    ...
    vec3 f25 = -CB0[16].xyz;
    float f26 = (dot(f3, f25) * CB0[14].w) * ((1.0 - ((step(f18.x, f19) * clamp(CB0[29].z + (CB0[29].w * abs(f19 - 0.5)), 0.0, 1.0)) * f18.y)) * f16.y);
    ...
    float f57 = f51.y;
    float f58 = f51.z;
    vec3 f59 = ((((((((f40 - (f35 * f39)) * CB0[15].xyz) * f28) + (CB0[17].xyz * (f38 * clamp(-f26, 0.0, 1.0)))) + ((f15.xyz * (f15.w * 120.0)) * 1.0)) + ((f40 - (f48 * f39)) * (((((((CB0[40].xyz * f53) + (CB0[42].xyz * f54)) + (CB0[44].xyz * f55)) + (CB0[41].xyz * f56)) + (CB0[43].xyz * f57)) + (CB0[45].xyz * f58)) + (((((((CB0[34].xyz * f53) + (CB0[36].xyz * f54)) + (CB0[38].xyz * f55)) + (CB0[35].xyz * f56)) + (CB0[37].xyz * f57)) + (CB0[39].xyz * f58)) * f17)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f17))) * f8.xyz) + ((((f35 * (((f36 + (f36 * f36)) / (((f37 * f37) * ((f31 * 3.0) + 0.5)) * ((f30 * 0.75) + 0.25))) * f28)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f44, textureLod(PrefilteredEnvTexture, f42, f41).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f22.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f17)) * f48) * f20));
    vec4 f60 = vec4(0.0);
    f60.x = f59.x;
    vec4 f61 = f60;
    f61.y = f59.y;
