...
void main()
{
    ...
    float f20 = f19.x;
    float f21 = f19.y;
    vec3 f22 = f12 - CB0[46].xyz;
    vec3 f23 = f12 - CB0[47].xyz;
    vec3 f24 = f12 - CB0[48].xyz;
    vec4 f25 = vec4(f12, 1.0) * mat4(CB8[((dot(f22, f22) < CB0[46].w) ? 0 : ((dot(f23, f23) < CB0[47].w) ? 1 : ((dot(f24, f24) < CB0[48].w) ? 2 : 3))) * 4 + 0], CB8[((dot(f22, f22) < CB0[46].w) ? 0 : ((dot(f23, f23) < CB0[47].w) ? 1 : ((dot(f24, f24) < CB0[48].w) ? 2 : 3))) * 4 + 1], CB8[((dot(f22, f22) < CB0[46].w) ? 0 : ((dot(f23, f23) < CB0[47].w) ? 1 : ((dot(f24, f24) < CB0[48].w) ? 2 : 3))) * 4 + 2], CB8[((dot(f22, f22) < CB0[46].w) ? 0 : ((dot(f23, f23) < CB0[47].w) ? 1 : ((dot(f24, f24) < CB0[48].w) ? 2 : 3))) * 4 + 3]);
    ...
    float f30 = exp(CB0[51].z * f29);
    float f31 = -exp((-CB0[51].w) * f29);
    vec2 f32 = (f28 * CB0[52].y) * vec2(f30, f31);
    vec2 f33 = f32 * f32;
    float f34 = f26.x;
    ...
    float f39 = f31 - f37;
    float f40 = CB0[31].w * clamp(1.0 - (VARYING4.w * CB0[28].y), 0.0, 1.0);
    ...
    float f46 = clamp((f6 * CB0[14].w) * (((f6 * CB0[52].x) > 0.0) ? mix(min((f30 <= f34) ? 1.0 : clamp(((f35 / (f35 + (f36 * f36))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f31 <= f37) ? 1.0 : clamp(((f38 / (f38 + (f39 * f39))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f21, clamp((length(f12 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f21), 0.0, 1.0);
    float f47 = f41 * f41;
    ...
    float f75 = f69.y;
    float f76 = f69.z;
    vec3 f77 = (((((((f58 - (f53 * f57)) * CB0[15].xyz) * f46) + ((f18.xyz * (f18.w * 120.0)) * 1.0)) + ((f58 - (f66 * f57)) * (((((((CB0[40].xyz * f71) + (CB0[42].xyz * f72)) + (CB0[44].xyz * f73)) + (CB0[41].xyz * f74)) + (CB0[43].xyz * f75)) + (CB0[45].xyz * f76)) + (((((((CB0[34].xyz * f71) + (CB0[36].xyz * f72)) + (CB0[38].xyz * f73)) + (CB0[35].xyz * f74)) + (CB0[37].xyz * f75)) + (CB0[39].xyz * f76)) * f20)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f20))) * f11.xyz) + ((((f53 * (((f54 + (f54 * f54)) / (((f55 * f55) * ((f49 * 3.0) + 0.5)) * ((f48 * 0.75) + 0.25))) * f46)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f62, textureLod(PrefilteredEnvTexture, f60, f59).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f42.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f20)) * f66) * f40));
    vec4 f78 = vec4(0.0);
    f78.x = f77.x;
    vec4 f79 = f78;
    f79.y = f77.y;
