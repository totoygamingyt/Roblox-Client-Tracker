...
void main()
{
    ...
    float f45 = clamp((f5 * CB0[14].w) * (((f5 * CB0[52].x) > 0.0) ? mix(min((f29 <= f33) ? 1.0 : clamp(((f34 / (f34 + (f35 * f35))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f30 <= f36) ? 1.0 : clamp(((f37 / (f37 + (f38 * f38))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f20, clamp((length(f11 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f20), 0.0, 1.0);
    float f46 = f40 * f40;
    ...
    float f74 = f68.y;
    float f75 = f68.z;
    vec3 f76 = (((((((f57 - (f52 * f56)) * CB0[15].xyz) * f45) + ((f17.xyz * (f17.w * 120.0)) * 1.0)) + ((f57 - (f65 * f56)) * (((((((CB0[40].xyz * f70) + (CB0[42].xyz * f71)) + (CB0[44].xyz * f72)) + (CB0[41].xyz * f73)) + (CB0[43].xyz * f74)) + (CB0[45].xyz * f75)) + (((((((CB0[34].xyz * f70) + (CB0[36].xyz * f71)) + (CB0[38].xyz * f72)) + (CB0[35].xyz * f73)) + (CB0[37].xyz * f74)) + (CB0[39].xyz * f75)) * f19)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f19))) * f10.xyz) + ((((f52 * (((f53 + (f53 * f53)) / (((f54 * f54) * ((f48 * 3.0) + 0.5)) * ((f47 * 0.75) + 0.25))) * f45)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f61, textureLod(PrefilteredEnvTexture, f59, f58).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f41.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f19)) * f65) * f39));
    vec4 f77 = vec4(0.0);
    f77.x = f76.x;
    vec4 f78 = f77;
    f78.y = f76.y;
