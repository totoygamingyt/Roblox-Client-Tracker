...
void main()
{
    ...
    vec3 f45 = -CB0[16].xyz;
    float f46 = (dot(f23, f45) * CB0[14].w) * ((1.0 - ((step(f38.x, f39) * clamp(CB0[29].z + (CB0[29].w * abs(f39 - 0.5)), 0.0, 1.0)) * f38.y)) * f36.y);
    ...
    float f77 = f71.y;
    float f78 = f71.z;
    vec3 f79 = ((((((((f60 - (f55 * f59)) * CB0[15].xyz) * f48) + (CB0[17].xyz * (f58 * clamp(-f46, 0.0, 1.0)))) + ((f35.xyz * (f35.w * 120.0)) * 1.0)) + ((f60 - (f68 * f59)) * (((((((CB0[40].xyz * f73) + (CB0[42].xyz * f74)) + (CB0[44].xyz * f75)) + (CB0[41].xyz * f76)) + (CB0[43].xyz * f77)) + (CB0[45].xyz * f78)) + (((((((CB0[34].xyz * f73) + (CB0[36].xyz * f74)) + (CB0[38].xyz * f75)) + (CB0[35].xyz * f76)) + (CB0[37].xyz * f77)) + (CB0[39].xyz * f78)) * f37)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f37))) * f28.xyz) + ((((f55 * (((f56 + (f56 * f56)) / (((f57 * f57) * ((f51 * 3.0) + 0.5)) * ((f50 * 0.75) + 0.25))) * f48)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f64, textureLod(PrefilteredEnvTexture, f62, f61).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f42.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f37)) * f68) * f40));
    vec4 f80 = vec4(0.0);
    f80.x = f79.x;
    vec4 f81 = f80;
    f81.y = f79.y;
