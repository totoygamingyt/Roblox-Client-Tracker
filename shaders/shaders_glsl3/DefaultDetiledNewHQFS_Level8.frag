...
void main()
{
    ...
    float f76 = clamp((f36 * CB0[14].w) * (((f36 * CB0[52].x) > 0.0) ? mix(min((f60 <= f64) ? 1.0 : clamp(((f65 / (f65 + (f66 * f66))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0), (f61 <= f67) ? 1.0 : clamp(((f68 / (f68 + (f69 * f69))) - 0.20000000298023223876953125) * 1.25, 0.0, 1.0)), f51, clamp((length(f42 - CB0[11].xyz) * CB0[51].y) - (CB0[51].x * CB0[51].y), 0.0, 1.0)) : f51), 0.0, 1.0);
    float f77 = f71 * f71;
    ...
    float f105 = f99.y;
    float f106 = f99.z;
    vec3 f107 = (((((((f88 - (f83 * f87)) * CB0[15].xyz) * f76) + ((f48.xyz * (f48.w * 120.0)) * 1.0)) + ((f88 - (f96 * f87)) * (((((((CB0[40].xyz * f101) + (CB0[42].xyz * f102)) + (CB0[44].xyz * f103)) + (CB0[41].xyz * f104)) + (CB0[43].xyz * f105)) + (CB0[45].xyz * f106)) + (((((((CB0[34].xyz * f101) + (CB0[36].xyz * f102)) + (CB0[38].xyz * f103)) + (CB0[35].xyz * f104)) + (CB0[37].xyz * f105)) + (CB0[39].xyz * f106)) * f50)))) + (CB0[32].xyz + ((CB0[33].xyz * (2.0 - CB0[14].w)) * f50))) * f41.xyz) + ((((f83 * (((f84 + (f84 * f84)) / (((f85 * f85) * ((f79 * 3.0) + 0.5)) * ((f78 * 0.75) + 0.25))) * f76)) * CB0[15].xyz) * (CB0[14].w * CB0[14].w)) + ((mix(f92, textureLod(PrefilteredEnvTexture, f90, f89).xyz * mix(CB0[31].xyz, CB0[30].xyz, vec3(clamp(f72.y * 1.58823525905609130859375, 0.0, 1.0))), vec3(f50)) * f96) * f70));
    vec4 f108 = vec4(0.0);
    f108.x = f107.x;
    vec4 f109 = f108;
    f109.y = f107.y;
