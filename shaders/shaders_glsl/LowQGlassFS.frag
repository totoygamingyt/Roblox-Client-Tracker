...
void main()
{
    ...
    vec3 f21 = (((VARYING6.xyz * f19) + min((f14.xyz * (f14.w * 120.0)) + (CB0[13].xyz + (CB0[14].xyz * f16)), vec3(CB0[21].w))) * ((mix(vec3(1.0), (f20 * f20) * CB0[20].x, vec3(f16)) * VARYING7.w) + (f9.xyz * (VARYING2.w - VARYING7.w)))) + (CB0[15].xyz * ((VARYING6.w * f19) * 0.100000001490116119384765625));
    vec4 f22 = vec4(0.0);
    f22.x = f21.x;
    vec4 f23 = f22;
    f23.y = f21.y;
